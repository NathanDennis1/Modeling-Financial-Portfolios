...
df_infotable_ts.to_csv(f"{base_subdir}/timeseries_INFOTABLE.tsv", sep="\t", index=False)
print("Saving coverpage...")
df_coverpage_ts.to_csv(f"{base_subdir}/timeseries_COVERPAGE.tsv", sep="\t", index=False)
print("Saving summarypage...")
df_summarypg_ts.to_csv(f"{base_subdir}/timeseries_SUMMARYPAGE.tsv", sep="\t", index=False)
print("Saving submission...")
df_submissio_ts.to_csv(f"{base_subdir}/timeseries_SUBMISSION.tsv", sep="\t", index=False)
print("Done!")